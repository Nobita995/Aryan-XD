...
“ Hola *%name* soy *Musix-Bot*, %greeting ”
...
exp: exp - min,
maxexp: xp,
botofc: (conn.user.jid == global.conn.user.jid ? '🚩 𝙴𝚂𝚃𝙴 𝙴𝚂 𝙴𝙻 𝙱𝙾𝚃 𝙾𝙵𝙲' : `🚩 Wa.me/${global.conn.user.jid.split`@`[0]}`), 
totalexp: exp,
xp4levelup: max - exp,
...
const pp = await conn.profilePictureUrl(who, 'image').catch(_ => 'https://imgur.com/gallery/L2n9J2N')
...
await conn.sendMessage(
  ...
  contextInfo: {
    ...
    forwardedNewsletterMessageInfo: {
      ...
      newsletterName: '⏤͟͞ू𓂃🎀 ͢𝐌᭄𝐮͎𝐬͎̽𝐢𝐱͜͡͡ ❥͜͡⋆᭄᳭̽̽»⃪ ፝͜⁞✰⃔࿐/𒄬 ⃝⃝𝐀– 𝐫𝐲͡𝐚͜𝐧 𝐱͜͡ᴆ ⸙ -❯ ⋆̟(◣_◢)凸',
      serverMessageId: -1,
    },
    forwardingScore: 999,
    externalAdReply: {
      title: '⏤͟͞ू⃪ 𓂃🎀 ͢𝐌᭄𝐮͎𝐬͎̽𝐢𝐱͜͡͡ ❥͜͡⋆᭄᳭̽̽✰⃔࿐',
      body: dev,
      thumbnailUrl: icono,
      sourceUrl: redes,
      mediaType: 1,
