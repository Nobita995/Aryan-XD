...
let fkontak = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: { 'contactMessage': { 'displayName': wm, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${wm},;;;\nFN:${wm},\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabell:Ponsel\nEND:VCARD`, 'jpegThumbnail': fs.readFileSync('./Menu.jpg'), thumbnail: fs.readFileSync('./Menu.jpg'),sendEphemeral: true}}}
   let txt = '╭─╮︹︹⊹︹︹⊹︹︹⊹︹︹╭─╮\n    ⚘݄𖠵⃕⁖𖥔͢Menu ꪶ͢𝑩𝒐𝒕⋆᭄͙̈\n╚▭࣪▬ִ▭࣪▬ִ▭࣪▬ִ▭࣪▬ִ▭࣪▬ִ▭࣪▬▭╝'
    let interactiveMessage = {
        header: { title: '> 𝑩𝒊𝒆𝒏𝒗𝒆𝒏𝒊𝒅𝒐 𝒂𝒍 𝑴𝑬𝑵𝑼-𝑳𝑰𝑺𝑻                                      ⏤͟͞ू⃪ ፝͜⁞𓂃🎀 ͢𝐌᭄𝐮͎𝐬͎̽𝐢𝐱͜͡͡ ❥͜͡⋆᭄᳭̽̽»✰⃔࿐' },
...
description: "ɴᴜᴍʙᴇʀ ᴏғɪᴄɪᴀʟᴇs ᴏᴡɴᴇʀ ᴀʀʏᴀɴ",
id: `${prefijo}owner`
},
{
title: "│🔥│ɢʀᴜᴘᴏs ᴏғᴄ ᴅᴇʟ ʙᴏᴛ", 
description: "ᴏʙᴛᴇɴ ʟᴀ ʟɪsᴛᴀ ᴅᴇ ʟᴏs ɢʀᴜᴘᴏs ᴏғɪᴄɪᴀʟᴇs ᴅᴇ ᴍᴜsɪx-ʙᴏᴛ",
id: `${prefijo}grupos`
},
{
...
{
title: "│❔│ɪɴғᴏ ᴅᴇʟ ʙᴏᴛ", 
description: "ᴏʙᴛᴇɴ ʟᴀ ɪɴғᴏʀᴍᴀᴄɪᴏɴ ᴅᴇ ᴍᴜsɪx-ʙᴏᴛ",
id: `${prefijo}infobot`
},
{
...
{
title: 'Sᴘ', highlight_label: "ɴᴘ",
rows: [
{
title: "│🔗│ʙᴏᴛᴄʟᴏɴᴇ", 
description: "ᴄᴏɴᴠɪᴇ́ʀᴛᴇᴛᴇ ᴇɴ ᴜɴ ᴄʟᴏɴ ᴅᴇ ᴇsᴛᴇ ɪɴᴄʀᴇɪ́ʙʟᴇ ʙᴏᴛ ᴇsᴄᴀɴᴇᴀɴᴅᴏ ᴜɴ ᴇɴ ᴛᴜ ᴡʜᴀᴛsᴀᴘᴘ",
id: `${prefijo}nobot`
},
{
title: "│🗑│ᴅᴇʟᴇᴛᴇʙᴏᴛ", 
description: "ᴇʟɪᴍɪɴᴀ ᴛᴜ ᴄᴏᴘɪᴀ (sᴜʙʙᴏᴛ) ᴅᴇ ᴍᴜsɪx-ʙᴏᴛ",
...
let ti1 = '𝐸𝑥𝑝𝑙𝑜𝑠𝑖𝑜𝑛!!'
let ti2 = '𝐻𝑜𝑙𝑎!!'
let ti3 = '⏤͟͞ू⃪ ፝͜⁞𓂃🎀 ͢𝐌᭄𝐮͎𝐬͎̽𝐢𝐱͜͡͡ ❥͜͡⋆᭄᳭̽̽»✰⃔࿐'
let ti4 = '͟͞ 𒄬 ⃝⃝𝐀– 𝐫𝐲͡𝐚͜𝐧 𝐱͜͡ᴆ ⸙ -❯ ࠱࠭ ͟͞'
let ti5 = '𝐵𝑂𝑂𝑀𝑀!!!!'
