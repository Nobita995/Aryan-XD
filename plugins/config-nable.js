...
const miniopcion = `🚩 *OPTIONS FOR GROUPS*
...
🍟 *OPTIONS FOR MY OWNER*

${usedPrefix + command} public
${usedPrefix + command} status
${usedPrefix + command} notser
...
conn.reply(m.chat, `🍟  *The Function ${type} has been ${isEnable ? 'Activate' : 'Desactivate'} in the ${isAll ? 'Bot' : isUser ? '' : 'Chat.'}*`, m, rcanal, )
